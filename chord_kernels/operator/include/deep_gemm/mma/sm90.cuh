...
/// RS-mode BF16 MMA (register source A, shared memory descriptor B), K=16
template <int N_, typename MMA>
struct BF16MMARS {
    template <size_t ...Idx>
...
template <int N>
struct BF16MMASelectorRS {
    static constexpr auto select_mma() {
        using namespace cute::SM90::GMMA;
        constexpr auto kA = Major::K;
        constexpr auto kB = Major::K;
        if constexpr (N == 8) return MMA_64x8x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 16) return MMA_64x16x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 24) return MMA_64x24x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 32) return MMA_64x32x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 40) return MMA_64x40x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 48) return MMA_64x48x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 56) return MMA_64x56x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 64) return MMA_64x64x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 72) return MMA_64x72x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 80) return MMA_64x80x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 88) return MMA_64x88x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 96) return MMA_64x96x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 104) return MMA_64x104x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 112) return MMA_64x112x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 120) return MMA_64x120x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 128) return MMA_64x128x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 136) return MMA_64x136x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 144) return MMA_64x144x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 152) return MMA_64x152x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 160) return MMA_64x160x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 168) return MMA_64x168x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 176) return MMA_64x176x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 184) return MMA_64x184x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 192) return MMA_64x192x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 200) return MMA_64x200x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 208) return MMA_64x208x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 216) return MMA_64x216x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 224) return MMA_64x224x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 232) return MMA_64x232x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 240) return MMA_64x240x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 248) return MMA_64x248x16_F32BF16BF16_RS<kA, kB>();
        if constexpr (N == 256) return MMA_64x256x16_F32BF16BF16_RS<kA, kB>();
    }

    static constexpr auto select_type() {
        return BF16MMARS<N, decltype(select_mma())>();
    }
